...
<title>관리자의 특정회원의 등급을 재조정</title>
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body class = "container_fluid p-3 my-3  bg-dark text-white">
	<h1>회원 등급 수정</h1>
	<form id="UpdateMemberLevelForm" action="updateMemberLevelAction.jsp">
		<table class="table table-bordered table-dark">
			...
			<tr>
				<td>memberLevel</td>
				<td>
					<input type="radio" id="memberLevel" name="memberLevel" value="0">0. 일반 회원
					<input type="radio" id="memberLevel" name="memberLevel" value="1">1. 관리자
				</td>
			</tr>
		</table>
	...
	<script>
		$('#btn').click(function(){
			...
			let memberLevel = $('.memberLevel:checked'); // . 클래스속성으로 부르면 리턴값은 배열
			if(memberLevel.length == 0) {
				alert('memberLevel를 선택하세요');
				return;
			}
